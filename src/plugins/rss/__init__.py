...
data = {
    'rsshub': 'http://181.214.21.250:1200',
    'proxy': '',
    'proxy_urls': [],
    'last_time': {},
    'group_rss': {},
...
async def group_process():
    bot = get_bot()
    groups = [825852520, 1078699322, 236351615]
...
scheduler.add_job(job, "interval", minutes=1, id="rss")
